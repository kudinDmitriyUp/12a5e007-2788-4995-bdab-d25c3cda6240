...
export const metadata: Metadata = {
  title: "Vitality Chiropractic | Premium Wellness Care",
  description: "Experience premium chiropractic care from expert doctors. Specialized spinal alignment, therapeutic massage, and wellness consulting for optimal health.",
  keywords: "chiropractor, chiropractic care, spinal alignment, therapeutic massage, wellness clinic, pain relief",
  openGraph: {
    title: "Vitality Chiropractic | Premium Wellness Care",
    description: "Expert chiropractic treatment and wellness services for optimal health recovery.",
    siteName: "Vitality Chiropractic",
    type: "website"
  },
  robots: {
    index: true,
